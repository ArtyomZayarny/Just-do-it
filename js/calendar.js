                ...
                <header class="calendar__head">
                    <div class="calendar__nav">
                        <div id='calendar-left-btn' class="calendar__btn">
                            <span class="icon-arrow-left"><i class="fa fa-chevron-left" aria-hidden="true"></i></span>
                        </div>
                        ...
                        <div id='calendar-right-btn' class="calendar__btn">
                            <span class="icon-arrow-right"><i class="fa fa-chevron-right" aria-hidden="true"></i></span>
                        </div>
                    </div>
